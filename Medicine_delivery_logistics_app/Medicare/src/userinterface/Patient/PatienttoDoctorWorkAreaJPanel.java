 ...
 * @author Rohan
 */
public class PatienttoDoctorWorkAreaJPanel extends javax.swing.JPanel {

    /**
     * Creates new form PatienttoDoctorWorkAreaJPanel
     */
     ...
     */
    public PatienttoDoctorWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, PatientOrganization organization, Enterprise enterprise, EcoSystem business) {
        initComponents();
    ...
    private void initComponents() {
        ...
        workRequestJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Disease/Symptoms", "Date", "Status", "Result", "Medicines Given ", "Quantity", "Next Appointmment Date", "Other Comments"
            }
        ) {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 1000, 97));
        ...
        refreshTestJButton.setBackground(new java.awt.Color(255, 204, 0));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/Patient/doctor1.jpg"))); // NOI18N
...
//            organization.getWorkQueue().getWorkRequestList().remove(p);
    ...
    private void backJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backJButtonActionPerformed
        ...
        dwjp.populateTreatmentRequestTable();
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
