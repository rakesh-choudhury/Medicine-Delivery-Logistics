...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(submitJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 360, 220, -1));
        ...
        add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 440, -1, -1));
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        UserAccount account = null;
         if (enterprise.getEnterpriseType() == Enterprise.EnterpriseType.Patient) {
            account = enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new PatientAdminRole());
        } else if (enterprise.getEnterpriseType() == Enterprise.EnterpriseType.HealthCamps) {
        ...
        } else if (enterprise.getEnterpriseType() == Enterprise.EnterpriseType.Funding) {
            account = enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new HealthCampsAdmin());
